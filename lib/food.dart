...
class _FoodState extends State<Food> {
  ...
  FoodItemData(food: "Almonds", calories: 140.0),
  ...
  FoodItemData(food: "Chia Seeds", calories: 126.0),
  ...
  FoodItemData(food: "Chickpeas", calories: 169.0),
  FoodItemData(food: "Green Beans", calories: 31.0),
  FoodItemData(food: "Pumpkin Seeds", calories: 159.0),
  FoodItemData(food: "Walnuts", calories: 154.0),
  ...
  FoodItemData(food: "Whole Wheat Bread", calories: 137.0),
  FoodItemData(food: "Pasta", calories: 221.0),
  FoodItemData(food: "Cheese", calories: 132.0),
  FoodItemData(food: "Yogurt", calories: 71.0),
